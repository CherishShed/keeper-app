...
function Note(props) {
    return (
        ...
        <div index={props.index} className='note' >
            ...
            <button style={{ border: "none", color: "orange", position: "absolute", right: "10px", top: "0", background: "transparent", fontSize: "12px" }} onClick={() => { props.handleDelete(props.index) }}>Delete</button>
        </div>
